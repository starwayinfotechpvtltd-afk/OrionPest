      ...
      <div className="w-full md:w-[80%] lg:w-[60%] mx-auto relative px-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside md:text-right mt-3 text-lg">
              <li>
                ...
                Non-repellent baits carried back to the nest are most effective
        ...
        <div className="bg-gradient-to-b from-[#FFF300] to-[#FEBA00] relative mt-52 pt-10 px-10 md:px-20 pb-60 md:pb-80 rounded-4xl flex flex-col gap-7">
          <p className="text-lg">
            ...
            inspection, identification, monitoring, and targeted treatment. Our
            process begins with a thorough inspection of your property, where
            our trained professionals carefully analyze signs of pest activity.
            Next, we move to identification, ensuring we correctly recognize the
            exact pest species and the root causes of the infestation. Finally,
            our treatment phase focuses on using the safest, most effective, and
          ...
          <p className="text-lg">
            ...
            customers with sanitation advice. In the case of bed bugs, which
            hide in mattresses and furniture and feed on human blood, Orion
            offers advanced heat and chemical treatment combinations that
            eradicate them from even the tiniest cracks. Termite control is
            another area where our expertise shines, as termites silently damage
            wooden structures and furniture. We use soil treatments, liquid
            barriers, and monitoring systems to stop termite colonies before
            they cause irreversible harm. For birds, which can spread diseases
            and damage property, we install humane deterrents such as nets,
          ...
          <p className="text-lg">
            ...
            as rats and mice, we combine traps, baiting stations, and
            entry-point sealing to ensure complete rodent exclusion. Finally,
            for ants, which may invade homes and food supplies, our technicians
          ...
          <p className="text-lg">
            ...
            and structural repairs to reduce pest entry points. By combining
            cutting-edge technology, eco-friendly methods, and continuous
            monitoring, Orion ensures that your home or business stays pest-free
            throughout the year. Our IPM approach guarantees that treatments are
          ...
          <p className="text-lg">
            ...
            plans, regular inspections, and guaranteed results, Orion makes sure
            that pests are not only removed but also kept away for good. This
            dedication to excellence and eco-conscious pest control is why
            thousands of customers rely on Orion as their long-term pest
            management partner.
          </p>
        </div>
      </div>
