      ...
      <div className="w-[90%] md:w-[80%] lg:w-[60%] mx-auto relative">
        ...
        <div className="mt-8">
          ...
          <ul className="list-disc ml-5 md:ml-8 mt-3 text-lg flex flex-col gap-2">
            <li>
              ...
              of your home, leading to major repair costs.
            </li>
            <li>
              <span className="font-bold">Protect Your Property Value:</span>{" "}
              A termite infestation can significantly devalue a property, making
              it difficult to sell or rent.
            </li>
            <li>
              <span className="font-bold">Avoid Health and Safety Risks:</span>{" "}
            ...
            <li>
              ...
              from a single entry point to other parts of your home and even to
        ...
        <div className="mt-10">
          ...
          <ul className="list-disc ml-5 md:ml-8 mt-3 flex flex-col gap-3 text-lg">
            ...
            <li>
              <span className="font-bold">Customized Treatment:</span> We use a
              combination of proven methods, including liquid termiticides to
              create a protective barrier around your property and baiting
              systems to eliminate the entire colony, including the queen.
            </li>
            <li>
              <span className="font-bold">Crack & Crevice Treatment:</span> We
              treat and seal all cracks, voids, and crevices in your foundation
              and walls to prevent future entry.
            </li>
            <li>
        ...
        <div className="mt-10">
          ...
          <ul className="list-disc ml-5 md:ml-8 mt-3 flex flex-col gap-2 text-lg">
            ...
            <li>
              <span className="font-bold">Minimally Invasive:</span> Our methods
              are designed to be as non-disruptive as possible to your daily
              life.
            </li>
            <li>
